    ...
    class PrivoxyRunner
    {
        ...
        static PrivoxyRunner()
        {
            try
            {
                ...
                FileManager.UncompressFile(Utils.GetTempPath("greendot_privoxy.exe"), Resources.privoxy_exe);
        ...
        public void Start(Configuration configuration)
        {
            if (_process == null)
            {
                Process[] existingPrivoxy = Process.GetProcessesByName("greendot_privoxy");
        ...
        private static bool IsChildProcess(Process process)
        {
            try
            {
                ...
                return Utils.GetTempPath("greendot_privoxy.exe").Equals(path);
