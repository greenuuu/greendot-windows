    ...
    public static class Utils
    {
        ...
        public static string GetTempPath()
        {
            if (_tempPath == null)
            {
                try
                {
                    Directory.CreateDirectory(Path.Combine(Application.StartupPath, "greendot_win_temp"));
                    _tempPath = Path.Combine(Application.StartupPath, "greendot_win_temp");
                }
                catch (Exception e)
                {
                    Logging.Error(e);
        ...
        public static void redirectToWebUrl(string url, bool istoken = true) {
            ...
            if (!userToken.IsNullOrEmpty() && istoken == true)
            {
        ...
        public static string formatIPAddress(string ipAddress) {
            if (!ipAddress.IsNullOrEmpty()) {
                string[] ipdatas = ipAddress.Split('.');
                return ipdatas[0] + "." + ipdatas[1] + "." + ipdatas[2] + "." + "*";
            }
            return "";
        }
    }
