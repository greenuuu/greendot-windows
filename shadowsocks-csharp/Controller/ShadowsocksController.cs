...
namespace ShadowSocks.Controller
{
    public class ShadowSocksController
    {
        ...
        public void ToggleType(int serverIndex, bool globalEnabled)
        {
            _config.index = serverIndex;
            _config.global = globalEnabled;
